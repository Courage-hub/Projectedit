                ...
                <?php if (!isset($_SESSION['source'])) { ?>
                    ...
                    <div class="card shadow-lg">
                        <div class="card-header">
                            <h2 class="mb-0 text-center"><i class="bi bi-database"></i> Database migration from EDIT_V.6 to
                                EDIT_V.7</h2>
                        </div>
                        <div class="card-body">
                            <form method="post">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-4">
                                            <div class="card-header bg-primary text-white">
                                                <h3 class="mb-0"><i class="fa fa-server"></i> Server 1 (V.6)</h3>
                                            </div>
                                            <div class="card-body">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="source[dbname]" class="form-control"
                                                        placeholder="Database name" value="edit_0006" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-4">
                                            <div class="card-header bg-success text-white">
                                                <h3 class="mb-0"><i class="fa fa-server"></i> Server 2 (V.7)</h3>
                                            </div>
                                            <div class="card-body">
                                                <div class="mb-3">
                                                    <label class="form-label">Host</label>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="new_db" class="form-control"
                                                        placeholder="Name for the new database" value="edit_0007" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
