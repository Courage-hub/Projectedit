...
if (isset($_GET['id']) || isset($_GET['instruccion'])) {
    ...
    while ($filas = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='editor.php?id=" . $filas['id'] . "'>Edit</a> <br>
        <a href='eliminar.php?id=" . $filas['id'] . "' onclick=\"return confirm('¿Are you sure you want to delete this content?')\">Delete</a>
        </td>";
        echo "</tr>";
    }
    echo "</tbody>";
    ...
    echo "<td> No se han proporcionado criterios de búsqueda. <td>";
}
