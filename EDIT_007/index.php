...
require_once("includes/conexion_mysql.php"); // Agregar conexión a MySQL
...
$result_mysql = $conexion_mysql->query($query);
if (!$result_mysql) {
    die("Error al obtener datos de MySQL: " . $conexion_mysql->error);
}
?>
            ...
            <div class="table-container">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php while ($fila = odbc_fetch_array($result_access)): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php if ($fila['user_id'] == $_SESSION['id']): ?>
                                            <a href="editor.php?id=<?php echo $fila['id']; ?>" class="action-link">
                                                <i class="fas fa-edit me-1"></i>
                                            </a>
                                            <a href="eliminar.php?id=<?php echo $fila['id']; ?>" class="action-link delete"
            ...
            <div class="table-container">
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php while ($fila = $result_mysql->fetch_assoc()): ?>
                                <tr>
                                    <td><?php echo $fila['id'] ?></td>
                                    <td class="tit">
                                        <a href="details.php?id=<?php echo $fila['id']; ?>" class="text-decoration-none text-black">
                                    ...
                                    <td>
                                        ...
                                        if (intval($fila['user_id']) === intval($_SESSION['id'])): ?>
                                            <a href="editor.php?id=<?php echo $fila['id']; ?>" class="action-link">
                                                <i class="fas fa-edit me-1"></i>
                                            </a>
                                            <a href="eliminar.php?id=<?php echo $fila['id']; ?>" class="action-link delete"
